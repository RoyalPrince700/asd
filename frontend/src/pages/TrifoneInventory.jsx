...
export function TrifoneInventory() {
    ...
    <div className="page">
      <header className="page-head">
        ...
        <p className="lede tight">
          View live stock for Trifone Gadgets and Trifone Electronics. To update
          balances, post In or Out on the Stock movement page.
        </p>
      </header>
      ...
      <section className="table-wrap">
        <div className="section-head">
          <h2>{companyLabel(company, { short: true })} — All items</h2>
